...
public class SolarGUI {
    ...
    static Socket Real_Socket;
        static double tilt=0, azimuth=0; //to access in other functions 
    ...
    public static void main(String[] args) {
        ...
        sendButton.addActionListener(e -> {
            try {
                ...
                tilt = calculateOptimalTiltAngle(dayOfYear, latitude);
                azimuth = calculateOptimalAzimuthAngle(dayOfYear, hour, latitude);

                resultField.setText(String.format("Tilt: %.2f°, Azimuth: %.2f°", tilt, azimuth));
            } catch (Exception ex) {
    ...
    public static void PublishToNodes()
    {
            ...
            try
        {
            ...
            Client_Writer.println(tilt);
            Client_Writer.println(azimuth);
            Client_Writer.close();
            Server_Socket.close();
            Real_Socket.close();
        }
